...
public :
   ...
   TBranch        *b_biasCurrentCh0;   //!
   TBranch        *b_biasCurrentCh1;   //!
   TBranch        *b_biasCurrentCh2;   //!
   TBranch        *b_biasCurrentCh3;   //!
   TBranch        *b_humidity_RHDP4;   //!
   TBranch        *b_TCassette07;   //!
   TBranch        *b_tablePositionY;   //!
   TBranch        *b_humidity_air;   //!
   TBranch        *b_temperature_air;   //!
...
void HGCNtupleVariables::Init(TTree *tree, TTree *tree2, TTree *tree3)
{
   ...
   fChain3->SetBranchAddress("configuration", &configuration, &b_configuration);
   fChain3->SetBranchAddress("biasCurrentCh0", &biasCurrentCh0, &b_biasCurrentCh0);
   fChain3->SetBranchAddress("biasCurrentCh1", &biasCurrentCh1, &b_biasCurrentCh1);
   fChain3->SetBranchAddress("biasCurrentCh2", &biasCurrentCh2, &b_biasCurrentCh2);
   fChain3->SetBranchAddress("biasCurrentCh3", &biasCurrentCh3, &b_biasCurrentCh3);
   fChain3->SetBranchAddress("humidity_RHDP4", &humidity_RHDP4, &b_humidity_RHDP4);
   fChain3->SetBranchAddress("TCassette07", &TCassette07, &b_TCassette07);
   fChain3->SetBranchAddress("tablePositionY", &tablePositionY, &b_tablePositionY);
   fChain3->SetBranchAddress("humidity_air", &humidity_air, &b_humidity_air);
   fChain3->SetBranchAddress("temperature_air", &temperature_air, &b_temperature_air);
