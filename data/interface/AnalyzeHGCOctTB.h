...
class AnalyzeHGCOctTB : public HGCNtupleVariables{
 ...
 public:
  AnalyzeHGCOctTB(const TString &inputFileList="foo.txt", const char *outFileName="histo.root",const char *dataset="data", const char *config="alpha", const char* energy = "-1", int chi2_method = 0);
  ~AnalyzeHGCOctTB();
  Bool_t   FillChain(TChain *chain, TChain *chain2, TChain *chain3, const TString &inputFileList);
  /* Bool_t   FillChain(TChain *chain, const TString &inputFileList); */
  Long64_t LoadTree(Long64_t entry);
  //void     EventLoop(const char *,const char *);
  void     EventLoop(const char *, bool, int, int, const char *);
...
void AnalyzeHGCOctTB::BookHistogram(const char *outFileName, const char* conf,  const char* energy) {
  ...
  //spandey
  h_FH_debug = new TH2F("h_FH_debug","h_FH_debug",130,0,130,1000.0,0.0,5000.0);
  
  h_run_SS15 = new TH1F("h_run_SS15","run when SS = 15",15,580,595);
  ...
  /* h_rechit_energy_all->GetXaxis()->SetTitle("Energy in units of MI
Ps"); */
  ...
  //h_rechit_energy_raw_FH_vs_AH_MipsInEE = new TH2F("h_rechit_energy_raw_FH_vs_AH_MipsInEE","h_rechit_energy_raw_FH_vs_AH_MipsInEE",250.0,0,500.0,r2_x_bin,0.0,r2_x_max);
  ...
  h_rechit_energy_full_weighted_inGev_ShowerInEE_chi2_withoutAHCAL = new TH1F("h_rechit_energy_full_weighted_inGev_ShowerInEE_chi2_withoutAHCAL","h_rechit_energy_full_weighted_inGev_ShowerInEE_chi2_withoutAHCAL",y_max,0.0,y_max);
  h_rechit_energy_full_weighted_inGev_ShowerInEE_chi2_withoutAHCAL->GetXaxis()->SetTitle("Energy(GeV)");
  ...
  h_energy_MipsInEE_gev_chi2_withoutAHCAL = new TH1F("h_energy_MipsInEE_gev_chi2_withoutAHCAL","h_energy_MipsInEE_gev_chi2_withoutAHCAL",y_max,0.0,y_max);
  h_energy_MipsInEE_gev_chi2_withoutAHCAL->GetXaxis()->SetTitle("Energy(GeV)");
  ...
  h_rechit_energy_full_withEE_weighted_MipsInEE = new TH1F("h_rechit_energy_full_withEE_weighted_MipsInEE","h_rechit_energy_full_withEE_weighted_MipsInEE",xbin,0.0,x_2D_max);
  h_rechit_energy_full_withEE_weighted_MipsInEE->GetXaxis()->SetTitle("Energy in units of MIPs");

  h_rechit_energy_full_withoutEE_weighted_MipsInEE = new TH1F("h_rechit_energy_full_withoutEE_weighted_MipsInEE","h_rechit_energy_full_withoutEE_weighted_MipsInEE",xbin,0.0,x_2D_max);
  h_rechit_energy_full_withoutEE_weighted_MipsInEE->GetXaxis()->SetTitle("Energy in units of MIPs");
  ...
  // sprintf(hname,"h_longi_profile_MipsInEE_withAH_abs_energy_fraction");
  // h_longi_profile_MipsInEE_withAH_abs_energy_fraction = new TProfile(hname,hname,10000,-2.0,10.0);
  ...
  // sprintf(h_name,"h_longi_profile_MipsInEE_abs_fractionalE");
  // h_longi_profile_MipsInEE_abs_fractionalE = new TProfile(h_name,h_name,10000,-2.0,10.0);

  // sprintf(h_name,"h_longi_profile_ShowerInEE_abs_fractionalE");
  // h_longi_profile_ShowerInEE_abs_fractionalE = new TProfile(h_name,h_name,10000,-2.0,10.0);

  // sprintf(h_name,"h_longi_profile_inclusive_abs_fractionalE");
  // h_longi_profile_inclusive_abs_fractionalE = new TProfile(h_name,h_name,10000,-2.0,10.0);
  ...
  for(int i = 0; i < 40; i++) {
    ...
    /*   h_trackX_trackY_EE03_corrected = new TH2F("h_trackX_trackY_EE03_corrected","h_trackX_trackY_EE03_corrected",400,-10.0,10.0,400,-10.0,10.0); */
    /*   h_trackX_trackY_EE03_corrected->GetXaxis()->SetTitle("X"); */
    /*   h_trackX_trackY_EE03_corrected->GetYaxis()->SetTitle("Y"); */
    ...
    /*   h_rechitX_rechitY_EE03_corrected = new TH2F("h_rechitX_rechitY_EE03_corrected","h_rechitX_rechitY_EE03_corrected",20,-10.0,10.0,20,-10.0,10.0); */
    /*   h_rechitX_rechitY_EE03_corrected->GetXaxis()->SetTitle("X"); */
    /*   h_rechitX_rechitY_EE03_corrected->GetYaxis()->SetTitle("Y"); */

    /*   h_trackX_trackY_EE03_FULL_corrected = new TH2F("h_trackX_trackY_EE03_FULL_corrected","h_trackX_trackY_EE03_FULL_corrected",400,-10.0,10.0,400,-10.0,10.0); */
    /*   h_trackX_trackY_EE03_FULL_corrected->GetXaxis()->SetTitle("X"); */
    /*   h_trackX_trackY_EE03_FULL_corrected->GetYaxis()->SetTitle("Y"); */


    /*   h_trackX_EE03_track_corrected = new TH1F("h_trackX_EE03_track_corrected","h_trackX_EE03_track_corrected",400,-10.0,10.0); */
    /*   h_trackY_EE03_track_corrected = new TH1F("h_trackY_EE03_track_corrected","h_trackY_EE03_track_corrected",400,-10.0,10.0); */


    /*   h_trackX_EE03_FULL_corrected = new TH1F("h_trackX_EE03_FULL_corrected","h_trackX_EE03_FULL_corrected",400,-10.0,10.0); */
    /*   h_trackY_EE03_FULL_corrected = new TH1F("h_trackY_EE03_FULL_corrected","h_trackY_EE03_FULL_corrected",400,-10.0,10.0); */
    ...
    /*   h_trackX_rechitX_EE03_track_corrected = new TH2F("h_trackX_rechitX_EE03_track_corrected","h_trackX_rechitX_EE03_track_corrected",400,-10.0,10.0,20,-10.0,10.0); */
    /*   h_trackX_rechitX_EE03_track_corrected->GetXaxis()->SetTitle("track"); */
    /*   h_trackX_rechitX_EE03_track_corrected->GetYaxis()->SetTitle("rechit"); */


    /*   h_trackX_rechitX_EE03_track_rechit_corrected = new TH2F("h_trackX_rechitX_EE03_track_rechit_corrected","h_trackX_rechitX_EE03_track_rechit_corrected",400,-10.0,10.0,20,-10.0,10.0); */
    /*   h_trackX_rechitX_EE03_track_rechit_corrected->GetXaxis()->SetTitle("track"); */
    /*   h_trackX_rechitX_EE03_track_rechit_corrected->GetYaxis()->SetTitle("rechit"); */
    ...
    /*   h_trackY_rechitY_EE03_track_corrected = new TH2F("h_trackY_rechitY_EE03_track_corrected","h_trackY_rechitY_EE03_track_corrected",400,-10.0,10.0,20,-10.0,10.0); */
    /*   h_trackY_rechitY_EE03_track_corrected->GetYaxis()->SetTitle("track"); */
    /*   h_trackY_rechitY_EE03_track_corrected->GetYaxis()->SetTitle("rechit"); */


    /*   h_trackY_rechitY_EE03_track_rechit_corrected = new TH2F("h_trackY_rechitY_EE03_track_rechit_corrected","h_trackY_rechitY_EE03_track_rechit_corrected",400,-10.0,10.0,20,-10.0,10.0); */
    /*   h_trackY_rechitY_EE03_track_rechit_corrected->GetYaxis()->SetTitle("track"); */
    /*   h_trackY_rechitY_EE03_track_rechit_corrected->GetYaxis()->SetTitle("rechit"); */
    ...
    /*   h_dX_dY_EE03_after_full_correction = new TH2F("h_dX_dY_EE03_after_full_correction","h_dX_dY_EE03_after_full_correction",400,-10.0,10.0,400,-10.0,10.0); */
    /*   h_dX_dY_EE03_after_full_correction->GetXaxis()->SetTitle("dX"); */
    /*   h_dX_dY_EE03_after_full_correction->GetYaxis()->SetTitle("dY"); */
  ...
  h_trackX_trackY_EE15_corrected = new TH2F("h_trackX_trackY_EE15_corrected","h_trackX_trackY_EE15_corrected",400,-10.0,10.0,400,-10.0,10.0);
  h_trackX_trackY_EE15_corrected->GetXaxis()->SetTitle("X");
  h_trackX_trackY_EE15_corrected->GetYaxis()->SetTitle("Y");
  ...
  h_rechitX_rechitY_EE15_corrected = new TH2F("h_rechitX_rechitY_EE15_corrected","h_rechitX_rechitY_EE15_corrected",20,-10.0,10.0,20,-10.0,10.0);
  h_rechitX_rechitY_EE15_corrected->GetXaxis()->SetTitle("X");
  h_rechitX_rechitY_EE15_corrected->GetYaxis()->SetTitle("Y");

  h_trackX_trackY_EE15_FULL_corrected = new TH2F("h_trackX_trackY_EE15_FULL_corrected","h_trackX_trackY_EE15_FULL_corrected",400,-10.0,10.0,400,-10.0,10.0);
  h_trackX_trackY_EE15_FULL_corrected->GetXaxis()->SetTitle("X");
  h_trackX_trackY_EE15_FULL_corrected->GetYaxis()->SetTitle("Y");


  h_trackX_EE15_track_corrected = new TH1F("h_trackX_EE15_track_corrected","h_trackX_EE15_track_corrected",400,-10.0,10.0);
  h_trackY_EE15_track_corrected = new TH1F("h_trackY_EE15_track_corrected","h_trackY_EE15_track_corrected",400,-10.0,10.0);


  h_trackX_EE15_FULL_corrected = new TH1F("h_trackX_EE15_FULL_corrected","h_trackX_EE15_FULL_corrected",400,-10.0,10.0);
  h_trackY_EE15_FULL_corrected = new TH1F("h_trackY_EE15_FULL_corrected","h_trackY_EE15_FULL_corrected",400,-10.0,10.0);
  ...
  h_trackX_rechitX_EE15_track_corrected = new TH2F("h_trackX_rechitX_EE15_track_corrected","h_trackX_rechitX_EE15_track_corrected",400,-10.0,10.0,20,-10.0,10.0);
  h_trackX_rechitX_EE15_track_corrected->GetXaxis()->SetTitle("track");
  h_trackX_rechitX_EE15_track_corrected->GetYaxis()->SetTitle("rechit");


  h_trackX_rechitX_EE15_track_rechit_corrected = new TH2F("h_trackX_rechitX_EE15_track_rechit_corrected","h_trackX_rechitX_EE15_track_rechit_corrected",400,-10.0,10.0,20,-10.0,10.0);
  h_trackX_rechitX_EE15_track_rechit_corrected->GetXaxis()->SetTitle("track");
  h_trackX_rechitX_EE15_track_rechit_corrected->GetYaxis()->SetTitle("rechit");
  ...
  h_trackY_rechitY_EE15_track_corrected = new TH2F("h_trackY_rechitY_EE15_track_corrected","h_trackY_rechitY_EE15_track_corrected",400,-10.0,10.0,20,-10.0,10.0);
  h_trackY_rechitY_EE15_track_corrected->GetYaxis()->SetTitle("track");
  h_trackY_rechitY_EE15_track_corrected->GetYaxis()->SetTitle("rechit");


  h_trackY_rechitY_EE15_track_rechit_corrected = new TH2F("h_trackY_rechitY_EE15_track_rechit_corrected","h_trackY_rechitY_EE15_track_rechit_corrected",400,-10.0,10.0,20,-10.0,10.0);
  h_trackY_rechitY_EE15_track_rechit_corrected->GetYaxis()->SetTitle("track");
  h_trackY_rechitY_EE15_track_rechit_corrected->GetYaxis()->SetTitle("rechit");
  ...
  h_dX_dY_EE15_after_full_correction = new TH2F("h_dX_dY_EE15_after_full_correction","h_dX_dY_EE15_after_full_correction",400,-10.0,10.0,400,-10.0,10.0);
  h_dX_dY_EE15_after_full_correction->GetXaxis()->SetTitle("dX");
  h_dX_dY_EE15_after_full_correction->GetYaxis()->SetTitle("dY");
  ...
  h_trackX_trackY_FH10_corrected = new TH2F("h_trackX_trackY_FH10_corrected","h_trackX_trackY_FH10_corrected",400,-10.0,10.0,400,-10.0,10.0);
  h_trackX_trackY_FH10_corrected->GetXaxis()->SetTitle("X");
  h_trackX_trackY_FH10_corrected->GetYaxis()->SetTitle("Y");
  ...
  h_rechitX_rechitY_FH10_corrected = new TH2F("h_rechitX_rechitY_FH10_corrected","h_rechitX_rechitY_FH10_corrected",20,-10.0,10.0,20,-10.0,10.0);
  h_rechitX_rechitY_FH10_corrected->GetXaxis()->SetTitle("X");
  h_rechitX_rechitY_FH10_corrected->GetYaxis()->SetTitle("Y");

  h_trackX_trackY_FH10_FULL_corrected = new TH2F("h_trackX_trackY_FH10_FULL_corrected","h_trackX_trackY_FH10_FULL_corrected",400,-10.0,10.0,400,-10.0,10.0);
  h_trackX_trackY_FH10_FULL_corrected->GetXaxis()->SetTitle("X");
  h_trackX_trackY_FH10_FULL_corrected->GetYaxis()->SetTitle("Y");


  h_trackX_FH10_track_corrected = new TH1F("h_trackX_FH10_track_corrected","h_trackX_FH10_track_corrected",400,-10.0,10.0);
  h_trackY_FH10_track_corrected = new TH1F("h_trackY_FH10_track_corrected","h_trackY_FH10_track_corrected",400,-10.0,10.0);


  h_trackX_FH10_FULL_corrected = new TH1F("h_trackX_FH10_FULL_corrected","h_trackX_FH10_FULL_corrected",400,-10.0,10.0);
  h_trackY_FH10_FULL_corrected = new TH1F("h_trackY_FH10_FULL_corrected","h_trackY_FH10_FULL_corrected",400,-10.0,10.0);
  ...
  h_trackX_rechitX_FH10_track_corrected = new TH2F("h_trackX_rechitX_FH10_track_corrected","h_trackX_rechitX_FH10_track_corrected",400,-10.0,10.0,20,-10.0,10.0);
  h_trackX_rechitX_FH10_track_corrected->GetXaxis()->SetTitle("track");
  h_trackX_rechitX_FH10_track_corrected->GetYaxis()->SetTitle("rechit");


  h_trackX_rechitX_FH10_track_rechit_corrected = new TH2F("h_trackX_rechitX_FH10_track_rechit_corrected","h_trackX_rechitX_FH10_track_rechit_corrected",400,-10.0,10.0,20,-10.0,10.0);
  h_trackX_rechitX_FH10_track_rechit_corrected->GetXaxis()->SetTitle("track");
  h_trackX_rechitX_FH10_track_rechit_corrected->GetYaxis()->SetTitle("rechit");
  ...
  h_trackY_rechitY_FH10_track_corrected = new TH2F("h_trackY_rechitY_FH10_track_corrected","h_trackY_rechitY_FH10_track_corrected",400,-10.0,10.0,20,-10.0,10.0);
  h_trackY_rechitY_FH10_track_corrected->GetYaxis()->SetTitle("track");
  h_trackY_rechitY_FH10_track_corrected->GetYaxis()->SetTitle("rechit");


  h_trackY_rechitY_FH10_track_rechit_corrected = new TH2F("h_trackY_rechitY_FH10_track_rechit_corrected","h_trackY_rechitY_FH10_track_rechit_corrected",400,-10.0,10.0,20,-10.0,10.0);
  h_trackY_rechitY_FH10_track_rechit_corrected->GetYaxis()->SetTitle("track");
  h_trackY_rechitY_FH10_track_rechit_corrected->GetYaxis()->SetTitle("rechit");
  ...
  h_dX_dY_FH10_after_full_correction = new TH2F("h_dX_dY_FH10_after_full_correction","h_dX_dY_FH10_after_full_correction",400,-10.0,10.0,400,-10.0,10.0);
  h_dX_dY_FH10_after_full_correction->GetXaxis()->SetTitle("dX");
  h_dX_dY_FH10_after_full_correction->GetYaxis()->SetTitle("dY");
...
void AnalyzeHGCOctTB::Chi2_Weight_Map_Init(int chi2_method) {
  ...
  sprintf(f_name_EH,"../txt_maps/chi2_map/chi2_calib_factors_EH_hadrons_DATA_%d.txt",chi2_method);
  sprintf(f_name_H,"../txt_maps/chi2_map/chi2_calib_factors_H_hadrons_DATA_%d.txt",chi2_method);
...
AnalyzeHGCOctTB::AnalyzeHGCOctTB(const TString &inputFileList, const char *outFileName, const char* dataset, const char* config, const char* energy, int chi2_method) {
