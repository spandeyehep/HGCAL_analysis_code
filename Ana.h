...
// Fixed size dimensions of array or collections stored in the TTree if any.
  ...
  Double_t        thetaBeam;
   Double_t        phiBeam;
   Int_t           nBeamMC;
  vector<int>     *pdgIdBeamMC;
   vector<float>   *xBeamMC;
   vector<float>   *yBeamMC;
   vector<float>   *zBeamMC;
   vector<float>   *pxBeamMC;
   vector<float>   *pyBeamMC;
   vector<float>   *pzBeamMC;
   vector<float>   *pBeamMC;
  ...
  Ana(const char* fname=NULL, int beamEnergy = -1.0);
   virtual ~Ana();
   virtual Int_t    Cut(Long64_t entry);
   virtual Int_t    GetEntry(Long64_t entry);
   virtual Long64_t LoadTree(Long64_t entry);
   virtual void     Init(TTree *tree);
   virtual void     Loop(const char* outFile);
...
//Ana::Ana(const char* fname = NULL, int beamEnergy = -1) : fChain(0)
Ana::Ana(const char* fname, int beamEnergy)
{
  energy = beamEnergy;
...
void Ana::Init(TTree *tree)
{
   ...
   fChain->SetBranchAddress("nBeamMC", &nBeamMC, &b_nBeamMC);
   fChain->SetBranchAddress("pdgIdBeamMC", &pdgIdBeamMC, &b_pdgIdBeamMC);
   fChain->SetBranchAddress("xBeamMC", &xBeamMC, &b_xBeamMC);
   fChain->SetBranchAddress("yBeamMC", &yBeamMC, &b_yBeamMC);
   fChain->SetBranchAddress("zBeamMC", &zBeamMC, &b_zBeamMC);
   fChain->SetBranchAddress("pxBeamMC", &pxBeamMC, &b_pxBeamMC);
   fChain->SetBranchAddress("pyBeamMC", &pyBeamMC, &b_pyBeamMC);
   fChain->SetBranchAddress("pzBeamMC", &pzBeamMC, &b_pzBeamMC);
   fChain->SetBranchAddress("pBeamMC", &pBeamMC, &b_pBeamMC);
