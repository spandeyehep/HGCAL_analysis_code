...
void AnalyzeHGCOctTB::EventLoop(const char *data) {
  ...
  for (jentry=0; jentry<nentries;jentry++) {
	...
	//spandey
	// cout<<"Before Correction = "<<recx<<","<<recx<<endl;
	if(!strcmp(data,"data")) {
	  ...
	  //spandey
	  // cout<<"Layer = "<<temp_layer<<", shiftx ="<<dx_corr<<" ,shifyx ="<<dy_corr<<endl;
	}
	//spandey
	// cout<<"After Correction = "<<recx<<","<<recx<<endl;
	...
	// cout<<"BEFORE ====="<<endl;
	// cout<<"module_layer_-1 = "<<module_layer_-1<<" ,"
	//     <<"module_position_-1 = "<<module_position_-1<<" ,"
	//     <<"NRechits_FH[][] = "<<NRechits_FH[module_layer_-1][module_position_-1]<<endl;
	...
	// if(module_position_ == 4) {
	//   cout<<"ROMEO HOTEL = "<<NRechits_FH[module_layer_-1][module_position_-1]<<endl;
	//   cout<<rechit_layer->at(i)<< ", " <<module_layer_ 
	//       << ", "<< module_position_<<", "<<rechit_module->at(i)<<endl;
	// }
